...
function textInChart() {
  if (results.correctAnswers > results.wrongAnswers) {
    return (chartText.innerHTML = `<h3>Congratulations!</h3><p id="correctAnswers">You passed the exam.</p><br/><p>Check your resume <br/> below </p>`);
  } else {
    return (chartText.innerHTML = `<h3>Try Again!</h3><p id="wrongAnswers">You failed the exam</p><br/><p>Check your resume <br/> below </p>`);
  }
}
textInChart();
